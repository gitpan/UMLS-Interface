...
#  check that no errors occured in the initalization process
...
if($obtained ne $expected) { print "no ok 4\n"; }
else                       { print "ok 4\n";    }
...
if($obtained ne $expected) { print "no ok 26\n"; }
else                       { print "ok 26\n";    }
...
if($obtained eq "") { print "no ok 28\n"; }
else                { print "ok 28\n";    }

#  check the validCui() function
$expected = 1;
$obtained = $umls->validCui("C0005768");
if($obtained eq $expected) { print "no ok 29\n"; }
else                       { print "ok 29\n";    }

$expected = 0;
$obtained = $umls->validCui("C000576");
if($obtained eq $expected) { print "no ok 30\n"; }
else                       { print "ok 30\n";    }
