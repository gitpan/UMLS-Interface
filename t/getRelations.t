...
if(!(-d "t")) {   
    ...
    print STDERR "directory as : perl t/getRelations.t \n";
    exit;  
}                                                              
...
my $perl     = $^X;
my $util_prg = File::Spec->catfile('utils', 'getRelations.pl');
...
#######################################################################################
$term    = "hand";
$file    = "getRelations.mth.rb-rn.$term";
...
#######################################################################################
$cui    = "C0018563";
$file    = "getRelations.mth.rb-rn.$cui";
$keyfile = File::Spec->catfile($keydir, $file);
$config  = File::Spec->catfile('t', 'config', 'config.mth.rb-rn');
