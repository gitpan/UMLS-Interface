...
findMinimumCuiDepth.pl - this program returns the minimum depth of a given CUI

=head1 SYNOPSIS

This program takes in a CUI and returns its minimum depth
...
sub minimalUsageNotes {
    ...
    print "Usage: findMinimumCuiDepth.pl [OPTIONS] CUI \n\n";
    &askHelp();
    exit;
}
...
##############################################################################
sub showVersion {
    print '$Id: findMinimumCuiDepth.pl,v 1.1 2009/01/21 22:31:02 btmcinnes Exp $';
